...
ORT_API_STATUS_IMPL(AddInput, _In_ OrtGraph* graph, _Inout_ const OrtValueInfo** value_info);
ORT_API_STATUS_IMPL(AddOutput, _In_ OrtGraph* graph, _Inout_ const OrtValueInfo** value_info);
